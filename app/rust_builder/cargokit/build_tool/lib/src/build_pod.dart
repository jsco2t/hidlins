...
class BuildPod {
  ...
  Future<void> build() async {
    ...
    // Hidlins patch: use libraryName, not packageName. With `[lib] name =
    // "hidlins_api"` the package is `hidlins-api` (hyphen) but the artifact is
    // `libhidlins_api.a` (underscore), which is what both podspecs -force_load.
    // packageName here produced libhidlins-api.a and broke every macOS/iOS link.
