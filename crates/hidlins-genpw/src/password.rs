...
#[cfg(test)]
#[allow(unsafe_code)] // volatile-read zeroize verification — mirrors hidlins-core::secret pattern
mod tests {
    use super::*;
    ...
    fn zeroizing_output_zeroes_on_drop() {
        // Mirrors the hidlins-core::secret idiom (see comment block in
        // hidlins-core/src/secret.rs). We call `.zeroize()` explicitly
