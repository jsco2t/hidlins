...
//!
//! # fn main() -> Result<(), hidlins_core::VaultError> {
...
//!
//! ```no_run
//! use hidlins_core::{SearchOptions, Vault};
//!
//! # fn main() -> Result<(), hidlins_core::VaultError> {
//! # let path = std::path::Path::new("notes.kdbx");
//! # let master = hidlins_core::MasterPassword::new("pw".to_string());
...
//!
//! ```no_run
//! use hidlins_core::{EntryBuilder, Vault};
//!
//! # fn main() -> Result<(), hidlins_core::VaultError> {
//! # let path = std::path::Path::new("notes.kdbx");
//! # let master = hidlins_core::MasterPassword::new("pw".to_string());
...
pub use query::{EntrySummary, GroupSummary};
