//! Sensitive-buffer helpers internal to `hidlins-security`.
//!
...
///
/// Mirrors `hidlins_core::secret::MasterPassword`'s shape and rationale.
...
// `hidlins_core::secret::MasterPassword`'s pattern. Intentionally
...
mod tests {
    ...
    fn zeroize_clears_inner_bytes() {
        ...
        //
        // Pattern mirrors `hidlins_core::secret`'s evolved test
