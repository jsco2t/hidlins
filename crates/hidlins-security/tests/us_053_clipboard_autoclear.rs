...
//!
//! These cases drive the production [`hidlins_security::Clipboard`]
...
/// what Hidlins wrote, the timer clears it.
#[test]
...
fn clipboard_preserved_when_another_app_overwrites_mid_ttl() {
    ...
    assert_eq!(
        ...
        "Hidlins must NOT stomp the user's intervening copy",
    );
...
/// cancels the timer — Hidlins's value stays on the clipboard until
