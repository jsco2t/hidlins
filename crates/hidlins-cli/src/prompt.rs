...
//!
//! 1. **Warn-and-remove** `HIDLINS_MASTER_PASSWORD` from the
...
/// Detect the `HIDLINS_MASTER_PASSWORD` env var; if set, write a
...
/// `hidlins-tui::terminal_guard::signals`: an async-signal-safe handler
