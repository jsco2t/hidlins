...
//! `hidlins entry {add, get, edit, rm, list, search}`.
//!
...
/// JSON output for `hidlins entry get`.
...
/// JSON envelope for `hidlins entry list`.
#[derive(Serialize, Debug)]
...
/// JSON envelope for `hidlins entry search`.
#[derive(Serialize, Debug)]
...
/// JSON output for `hidlins entry add`.
#[derive(Serialize, Debug)]
...
/// JSON output for `hidlins entry edit`.
#[derive(Serialize, Debug)]
...
/// JSON output for `hidlins entry rm`.
#[derive(Serialize, Debug)]
